...
export default {
  template: `
      <section v-if="book" class="book-details">
          ...
          <router-link :to.prevent="'/bookApp/book/'+prevBookId"><button>Previous Book</button></router-link>
          <router-link :to.prevent="'/bookApp/book/'+nextBookId"><button>Next Book</button></router-link>
          </div>
          <router-link to='/bookApp/book'><button class="closeBtn">Close</button></router-link>
